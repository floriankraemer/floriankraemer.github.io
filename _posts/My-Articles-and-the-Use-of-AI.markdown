...
I'm pretty sure you can get well written articles from an AI, but this requires you do already have a deep understanding of the topic to steer it to write the article in a direction that generates value for the reader and aligns with your intention to express a certain point regarding the topic.
...
I use AI primarily to correct grammar and mistakes or to rephrase sentences that, as a non-native English speaker, I can't always express as eloquently as I'd like. Given my autistic nature, it's also a helpful tool for expressing myself more kindly at times.

Sometimes I use AI to generate tabular data, because it is very annoying to write tables in Markdown for my articles.
...
You can use AI perfectly as a strong reviewer and sometimes even as a kind of co-author or coach, but it won't write whole outstanding and unique articles that reflect your personality. You'll have to put effort into this.
