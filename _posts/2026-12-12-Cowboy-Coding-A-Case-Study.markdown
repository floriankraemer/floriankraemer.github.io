...
- Absence of a Product Owner (or equivalent role)
- Absence of a maintained backlog.
...
- No observable self-driven improvements in the past ~8 months; improvements occur only when enforced by C-level management stakeholders.
- Lack of a culture of continuous learning or up-skilling.

### 4. Leadership Model & Authority

- The current laissez-faire approach is ineffective without skilled, motivated individuals, especially leaders who drive the development and teams.
...
- No clear authority for directives between developers and C-level; issues escalate very often directly to C-level, which pushes those stakeholders towards micro-management.
...
- Communication breakdowns across all levels, including C-level:
  ...
  - Knowledge and communication silos: Critical discussions happening in private channels, reducing transparency and information sharing.

### 8. Cultural & Motivational Environment

- The environment allows low-motivation individuals to persist without improvement, likely due to resistance to change.
...
- Effective AI use requires clear problem definition and contextual understanding, which is currently lacking, and of course the ability to understand and review what the AI did.
...
The goal here is to keep most of the people in place and make changes to the organizations structure and culture while at the same time up-skilling existing staff, to not have to replace anyone.
...
Hiring those people will require time, this is probably hard to do within less than 3-6 months to get the whole team together and form a functioning team. *First results should probably not be expected in less than 6 - 10 months.*
...
- None of the solutions will have a “kickstart” like effect that might be expected by the investor and C-level stakeholders.
