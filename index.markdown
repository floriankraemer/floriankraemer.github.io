...
<div class="hero-opportunity">
  <div class="opportunity-box">
    <h3 class="hero-subtitle">Software Architect & Developer with 23+ years of experience</h3>
    <p class="hero-description">
      ...
      system design, domain driven design and helping teams deliver better software.
    </p>
  </div>
</div>
